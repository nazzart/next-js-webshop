...
const Card: FC<{ data: Card }> = (props) => {
  return (
    <Link
      href={props.data.seoUrl}
      className="bg-white rounded flex flex-col md:flex-row mt-6 hover:shadow-lg transition-shadow"
    >
      ...
      <div className="basis-1/4 p-8 flex flex-row md:justify-center items-center">
        <span>from</span>{" "}
        <span className="text-2xl lg:text-5xl font-bold text-secondary pl-2">
          {props.data.price} €
        </span>
      </div>
    </Link>
